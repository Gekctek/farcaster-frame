...
import { idlFactory } from './frame.did.js';
export { idlFactory } from './frame.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FRAME_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./frame.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the frame canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./frame.did.js")._SERVICE>}
 */
export const frame = createActor(canisterId);
